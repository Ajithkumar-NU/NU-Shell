...
import 'package:nu_shell/screens/verificationcode.dart';
import 'package:nu_shell/utils/countrydropdown.dart';
import 'package:nu_shell/widgets/socialbottomsheet.dart';
...
class _VerifyScreeenState extends State<VerifyScreeen> {
  ...
  String _txtNumberHint = "970070100";
            ...
            child: Column(
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text(
                      "We have sent you an SMS with a code to number +91$_txtNumberHint",
                      textAlign: TextAlign.center,
